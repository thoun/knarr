...
$this->DESTINATIONS = [
    ...
    2 => new DestinationType([DIFFERENT => 3], [BRACELET => 1, FAME => 1, CARD => 1], [null, VP, null]),
    3 => new DestinationType([DIFFERENT => 3], [BRACELET => 1, RECRUIT => 1, CARD => 1], [null, VP, null]),
    4 => new DestinationType([DIFFERENT => 3], [BRACELET => 1], [VP, FAME, RECRUIT]),
    5 => new DestinationType([DIFFERENT => 3], [BRACELET => 1], [VP, FAME, RECRUIT]),
    ...
    9 => new DestinationType([BLUE => 2], [FAME => 2], [null, VP, FAME]),
    10 => new DestinationType([BLUE => 2], [RECRUIT => 1, FAME => 1], [FAME, null, VP]),
    11 => new DestinationType([BLUE => 2], [BRACELET => 1, FAME => 1], [null, FAME, VP]),
    ...
    16 => new DestinationType([YELLOW => 2], [FAME => 1], [VP, VP, null]),
    ...
    29 => new DestinationType([BLUE => 3, PURPLE => 2], [VP => 7, FAME => 2], [null, null, VP]),
